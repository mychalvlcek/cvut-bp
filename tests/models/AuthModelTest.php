...
require_once $_SERVER["DOCUMENT_ROOT"].'/src/models/AuthModel.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/cfg.php';

class AuthModelTest extends AbstractDatabaseTestCase {
	protected $m;
 
	protected function setUp() {
		// before
		$this->m = new AuthModel(new PDO('mysql:host=localhost;dbname=bp', 'root', 'root'));
	}
